  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-8">
      <Card className="w-full max-w-md p-6 sm:p-8 bg-white/95 backdrop-blur-2xl border border-pink-100/50 shadow-2xl shadow-pink-200/30 rounded-3xl">
        ...
        {/* Google Sign-in - Made more prominent */}
        <div className="mb-6">
          <Button
            onClick={handleGoogleAuth}
            disabled={googleLoading || loading}
            className="w-full bg-white border-2 border-gray-200 text-gray-700 hover:bg-gray-50 hover:border-gray-300 py-3 rounded-xl shadow-lg transition-all duration-300 flex items-center justify-center space-x-3"
          >
            {googleLoading ? (
