...
import { Loader2, Download, Share2, Heart, LogIn } from 'lucide-react';
...
const ImageGeneration: React.FC<ImageGenerationProps> = ({ onImageGenerated }) => {
  ...
  const downloadImage = () => {
    ...
    link.href = imageUrl;
    link.download = 'dream_image.png'; // Set the filename
      ...
      {imageUrl && (
        <div className="mt-6">
          ...
          <div className="flex justify-between mt-4">
            ...
            <Button onClick={shareImage} className="bg-blue-500 hover:bg-blue-600 text-white">
